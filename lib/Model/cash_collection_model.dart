import 'package:deliveryboy_ojarh/Model/order_model.dart';
...
class CashColl_Model {
  ...
  factory CashColl_Model.fromJson(Map<String, dynamic> parsedJson) {
    Order_Model orderDetails =
    //parsedJson['order_details'] =  Order_Model.fromJson(parsedJson['order_details']);

    parsedJson['order_details'] != ""
        ?  Order_Model.fromJson(parsedJson['order_details'])
        : Order_Model.fromJson({});
