...
const Color primary = Color(0xffff1744);
const Color secondary = Color(0xffeeeeee);
const Color fontColor = Color(0xff4caf50);
const Color grad1Color = Color(0xff212121);
const Color grad2Color = Color(0xffff1744);
